...
flags.DEFINE_string('dataset', 'OrganS_EC', 'Dataset string.')
...
flags.DEFINE_integer('num_clusters', 12, 'Number of clusters.')
flags.DEFINE_integer('bsize', 4, 'Number of clusters for each batch.')
